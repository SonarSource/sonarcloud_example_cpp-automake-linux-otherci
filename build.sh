...
#SONAR_TOKEN= # access token from SonarCloud projet creation page -Dsonar.login=XXXX: set in the environment through the CI
SONAR_PROJECT_KEY=sonarcloud_example_cpp-automake-linux-otherci # project key from SonarCloud projet creation page -Dsonar.projectKey=XXXX
SONAR_PROJECT_NAME=sonarcloud_example_cpp-automake-linux-otherci # project name from SonarCloud projet creation page -Dsonar.projectName=XXXX
